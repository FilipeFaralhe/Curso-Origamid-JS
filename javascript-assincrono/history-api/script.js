...
/*
  É possível acessarmos o histórico de acesso do browser em uma sessão específica através 
  do window.history. O objeto history possui diferentes métodos e propriedades.
*/

//window.history;
//window.history.back() // vai para a pagina anterior
...
// só funciona caso vc modifique o state com o pushState
...
/* 
  Ao puxarmos dados via fetch api, o url da página continua o mesmo. Ao combinar fetch 
  com a history api conseguimos simular uma navegação real entre páginas, sem a 
  necessidade de recarregamento da mesma.
*/
